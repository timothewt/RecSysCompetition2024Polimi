...
from libs.CythonCompiler.run_compile_subprocess import run_compile_subprocess
...
if __name__ == '__main__':
    ...
    subfolder_to_compile_list = [
        "libs/Recommenders/MatrixFactorization",
        "libs/Recommenders/Similarity",
        "libs/Recommenders/SLIM",
        "libs/Recommenders/FeatureWeighting",
        "libs/Utils/PyTorch",
    ]
